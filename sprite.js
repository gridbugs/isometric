...
Sprite.prototype.a = Sprite.prototype.add_frame;
Sprite.prototype.draw_next = function(ctx) {
    this.sequences[this.current_sequence].get_next_frame().draw_test(ctx);
}
...
$FR = Frame.create;
Frame.prototype.draw_test = function(ctx) {
    ctx.drawImage(
        // image to draw
        this.image,
        // offset into the original image to start drawing
